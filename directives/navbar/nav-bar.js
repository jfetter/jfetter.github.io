angular
  ...
  .controller("navCtrl", function(
    ...
    var dirtyDealer = {
      name: "Dirty Dealer",
      url: "https://dirtydeals.herokuapp.com",
      img: "images/dirtydealer.jpg",
      github:
        "https://github.com/rachelrobynslater/cards_against_humanity_clone.git"
    };
    var sling = {
      name: "Sales Sling",
      url: "https://www.salessling.com/",
      img: "images/sling.jpg",
      github: ""
    };
    var unfettered = {
      name: "unfettered",
      url: "http://www.unfetteredbook.com",
      img: "images/unfettered.jpg",
      github: "https://github.com/jfetter/unFetteredBook.git"
    };
    var hangman = {
      name: "hangman",
      url: "http://jfetter.github.io/accusor",
      img: "images/hangman.jpg",
      github: "https://github.com/jfetter/accusor.git"
    };
    //var poker = {name: "poker", url: "https://dry-mesa-2798.herokuapp.com/", img: "images/poker.jpg", github: "https://github.com/jfetter/sog.git"};
    $scope.projects = [dirtyDealer, sling, unfettered, hangman];
    ///// *** //scrolling// *** /////
    ...
    $scope.talkingPoints = {
      comment: "Have you seen what she can do with Angular",
      response: "OMG yes! This site is actually done in Angular"
    };
    var conversation = [
      //{comment: "have you seen what she can do with angular", response: "yeah it's amazing"},
      {
        comment: "Have you seen her with nunchucks",
        response:
          "You know she actually trained with the ninja turtles one summer"
      },
      {
        comment: "I think she channeld that fiestiness into her hangman game",
        response: "That app was built with good ol' fashioned jQuery."
      },
      {
        comment: "Did you know she made a multiplayer real time card game",
        response:
          "yeah, Dirty Dealer, its like Cards Against humanity but even better"
      },
      {
        comment: "She sucks at DDR though",
        response: "I know! Homegirl CANNOT dance"
      },
      {
        comment: "But she does put together a mean MEAN stack app!",
        response: "I know what you MEAN. Her app, 'Get To Work' is awesome!"
      }
    ];
